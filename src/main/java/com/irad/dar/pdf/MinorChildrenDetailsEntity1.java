...
public class MinorChildrenDetailsEntity1 {
	...
	public MinorChildrenDetailsEntity1(long id, String accId, String victimId, String name, String age, String sex,
			...
			String whoseChild, String userType) {
		super();
		this.id = id;
		this.accId = accId;
		this.victimId = victimId;
	...
	public String toString() {
		return "MinorChildrenDetailsEntity1 [id=" + id + ", accId=" + accId + ", victimId=" + victimId + ", name="
				+ name + ", age=" + age + ", sex=" + sex + ", caste=" + caste + ", fatherName=" + fatherName
				+ ", motherName=" + motherName + ", guardianName=" + guardianName + ", familyIncome=" + familyIncome
				...
				+ whoseChild + ", userType=" + userType + "]";
	}

	public MinorChildrenDetailsEntity1() {
		super();
