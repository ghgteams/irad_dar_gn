...
public class InsuranceDeceasedPojo {
	...
	public String toString() {
		return "InsuranceDeceasedPojo [id_insurance=" + id_insurance + ", vehicle_id=" + vehicle_id + ", accident_id="
				+ accident_id + ", person_id=" + person_id + ", person_type=" + person_type + ", death_income="
				+ death_income + ", death_future_prospects=" + death_future_prospects
				+ ", death_less_personal_expenses=" + death_less_personal_expenses + ", death_monthly_loss_depedency="
				+ death_monthly_loss_depedency + ", death_anual_loss_depedency=" + death_anual_loss_depedency
				+ ", death_mulltiplier=" + death_mulltiplier + ", death_total_loss_dependency="
				+ death_total_loss_dependency + ", death_medical_expenses=" + death_medical_expenses
				+ ", death_loss_consortium=" + death_loss_consortium + ", death_loss_for_love_affection="
				+ death_loss_for_love_affection + ", death_loss_estate=" + death_loss_estate
				+ ", death_loss_funeral_expenses=" + death_loss_funeral_expenses + ", death_total_compensation="
				+ death_total_compensation + ", death_interest=" + death_interest + "]";
	}
	public InsuranceDeceasedPojo(int id_insurance, String vehicle_id, String accident_id, String person_id,
			String person_type, String death_income, String death_future_prospects, String death_less_personal_expenses,
