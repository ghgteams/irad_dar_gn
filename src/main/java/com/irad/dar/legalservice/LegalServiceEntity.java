...
@Entity
@Table(name = "legal_services_authority_register", schema = "court")
public class LegalServiceEntity {
	...
	@Column(name="nameoflegalservice")
	private String nameoflegalservice;
	...
	public String getNameoflegalservice() {
		return nameoflegalservice;
	}

	public void setNameoflegalservice(String nameoflegalservice) {
		this.nameoflegalservice = nameoflegalservice;
	}
	...
	public LegalServiceEntity(int id, String rev_district, String nameoflegalservice, String rev_state,
			String rev_taluk, String ps_state, String ps_district, String ps_station, String court_type, String address,
			String pincode, String landline, String emailid, String lat, String lng, String profile_update_flag,
	...
	public String toString() {
		return "LegalServiceEntity [id=" + id + ", rev_district=" + rev_district + ", nameoflegalservice="
				+ nameoflegalservice + ", rev_state=" + rev_state + ", rev_taluk=" + rev_taluk + ", ps_state="
				+ ps_state + ", ps_district=" + ps_district + ", ps_station=" + ps_station + ", court_type="
				+ court_type + ", address=" + address + ", pincode=" + pincode + ", landline=" + landline + ", emailid="
				+ emailid + ", lat=" + lat + ", lng=" + lng + ", profile_update_flag=" + profile_update_flag
				+ ", profile_update_by=" + profile_update_by + ", profile_update_date=" + profile_update_date
				+ ", the_geom=" + the_geom + "]";
	}

	public LegalServiceEntity() {
		super();
