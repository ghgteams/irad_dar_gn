...
public class CourtListEntity {
	...
	public CourtListEntity(int id, String rev_district, String courtname, String rev_state, String rev_taluk,
	...
	public String toString() {
		return "CourtListEntity [id=" + id + ", rev_district=" + rev_district + ", courtname=" + courtname
