...
@Entity
@Table(name = "dar_petitioners_compensation_death", schema = "public")
public class PetitionerDeceasedEntity {
	...
	public PetitionerDeceasedEntity(int id, String vehicleId, String accidentId, String personId,
	...
	public String toString() {
		return "PetitionerDeceasedEntity [id=" + id  + ", vehicleId=" + vehicleId
	...
	public PetitionerDeceasedEntity() {
		super();
